      ...
      endDrawer: Drawer(
        ...
        child: ListView(
          children: <Widget>[
            ...
            ListTile(
              title: Text(
                  'Akil posted a task (Make Streaming) in Design channel!',
                  style: TextStyle(
            ...
            ListTile(
              title: Text(
                  'Akil Deleted a post (Make Poster) from Design channel',
                  style: TextStyle(
            ...
            ListTile(
              title: Text(
                  'Madhavan Marked as done a post (Flutter event) from Flutter channel',
                  style: TextStyle(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  ListTile(
                    tileColor: widget.cluster == 'Logout'
                        ? Color(0xffF4B400)
                        : Colors.transparent,
                    title: Text(
                      'Logout',
